...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AAAAOGXx2_8:APA91bGG9eO9vR3P6B2YAV5PugUFW6voPtZAshDDzqdJI7DvV_8TsvjaEzvh6L7wQYIJSDrvJJG-Kj9EF-E-RifiKx2oABhDMFPpAGOt2WfVNhaCSPvoyVMKrG5GmWbJap5Cw5EbdAfM";
    ...
    public FcmNotificationBuilder url(String url) {
        mUrl = url;
        return this;
    }
    ...
    private JSONObject getValidJsonBody() throws JSONException {
        ...
        Log.e("jsonObjectBody..",jsonObjectBody+"");
        ...
        jsonObjectData.put(KEY_URL,mUrl);
