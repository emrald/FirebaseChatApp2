package com.example.ti21.firebasechatapp2.core.chat;

import android.content.Context;
import android.provider.ContactsContract;
import android.util.Log;

import com.example.ti21.firebasechatapp2.fcm.FcmNotificationBuilder;
import com.example.ti21.firebasechatapp2.models.Chat;
import com.example.ti21.firebasechatapp2.utils.Constants;
import com.example.ti21.firebasechatapp2.utils.SharedPrefUtil;
    ...
    public void sendMessageToFirebaseUser(final Context context, final Chat chat, final String receiverFirebaseToken) {
        ...
        databaseReference.child(Constants.ARG_CHAT_ROOMS).getRef().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Log.e("TOKEN>>>>", new SharedPrefUtil(context).getString(Constants.ARG_FIREBASE_TOKEN) + "\n" + receiverFirebaseToken);
